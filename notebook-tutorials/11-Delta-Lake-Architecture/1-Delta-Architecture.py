...
dbutils.fs.ls(activityBronzePath)
...
# MAGIC 
# MAGIC In cell cmd27 this can be seen as a materialized view of the streaming data.
# MAGIC 
...
# MAGIC 
# MAGIC Instead, we'll define a temp table based on the files written to our silver table as shown in the cell cmd cmd 34. We will them use this table to execute our streaming queries.
# MAGIC 
# MAGIC In order to create a LIVE bar chart of the data, you'll need to fill out the <b>Plot Options</b> as shown in cell cmd35 by clicking on the chart icon:
# MAGIC 
