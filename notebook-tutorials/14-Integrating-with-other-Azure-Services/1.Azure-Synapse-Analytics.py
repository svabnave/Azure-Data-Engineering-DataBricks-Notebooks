...
storage_account_name = "adlsynapsebricks"
storage_account_key = "IsaX3WxvWbN4TaRf6LOPcIwDZGDjsGi+Uft6fuEvGaEJBFPiu4KI/KJ0Mv5gKPiLPFpa17DmXC8I1mfus0x8MQ=="
storage_container_name = "synapsefs"
...
# MAGIC %md
# MAGIC When merging many new customers into this table, we may have issues with uniqueness in the **`CurrencyKey`**. 
# MAGIC 
# MAGIC Let's redefine **`CurrencyAlternateKey`** for stronger uniqueness using a <a href="https://en.wikipedia.org/wiki/Universally_unique_identifier" target="_blank">UUID</a>. To do this, we will define a UDF and use it to transform the **`CurrencyAlternateKey`** column.
